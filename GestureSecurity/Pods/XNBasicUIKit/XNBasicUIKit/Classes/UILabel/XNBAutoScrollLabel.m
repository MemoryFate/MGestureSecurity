//
//  XNBAutoScrollLabel.m
//  XNBasicUIKit
//
//  Created by 江红胡 on 2018/3/27.
//

#import "XNBAutoScrollLabel.h"
...
@implementation XNBAutoScrollLabel
...
- (void)initialize
{
    ...
    // 初始化设置
    _direction = XNBAutoScrollDirectionType_Left;
...
- (void)setDirection:(XNBAutoScrollDirectionType)direction
{
...
- (void)scrollLabelIfNeeded
{
    ...
    if (self.direction != XNBAutoScrollDirectionType_Right && self.direction != XNBAutoScrollDirectionType_Left) {
    ...
    switch (self.direction) {
        case XNBAutoScrollDirectionType_Left:
            self.scrollView.contentOffset = CGPointZero;
            break;
        case XNBAutoScrollDirectionType_Right:
            self.scrollView.contentOffset = CGPointMake(width + self.labelSpacing, 0);
            break;
        case XNBAutoScrollDirectionType_Top:
            self.scrollView.contentOffset = CGPointZero;
            break;
        case XNBAutoScrollDirectionType_Bottom:
